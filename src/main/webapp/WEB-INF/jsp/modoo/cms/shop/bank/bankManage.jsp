...
<c:set var="pageTitle" value="은행 관리"/>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="card shadow page-wrapper">
		...
		<div class="card-body">
			<form:form modelAttribute="searchVO" id="searchForm" name="searchForm" method="get" action="${CTX_ROOT }/decms/shop/bank/bankList.json">
				<fieldset>
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="text-right">
							<c:url var="writeUrl" value="/decms/embed/shop/bank/writeBank.do"/>
							<a href="<c:out value="${writeUrl }"/>" class="btn btn-primary btn-sm btnAdd" data-target="#bankModal"><i class="fas fa-plus"></i> 신규등록</a>
						</div>
					</div>
				</div>
			</form:form>
		...
		<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable modal-dark">
			<div class="modal-content">
				<div class="modal-header">
					<h6 class="modal-title" id="bankModalLabel">수정</h6>
	...
	<javascript>
		...
		<script src="${CTX_ROOT}/resources/decms/shop/bank/js/bankManage.js"></script>
	</javascript>
</body>
</html>