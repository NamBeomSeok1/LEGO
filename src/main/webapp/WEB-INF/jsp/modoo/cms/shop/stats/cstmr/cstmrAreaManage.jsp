...
<c:set var="pageTitle" value="배송지역별 분석"/>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="card shadow page-wrapper">
		...
		<div class="card-body">
			<form:form modelAttribute="searchVO" id="searchForm" name="searchForm" method="get" action="${CTX_ROOT }/decms/shop/stats/cstmrAreaList.json">
			...
			<div class="mt-2">
				...
				<div class="text-right">
					<a href="${CTX_ROOT }/decms/shop/stats/cstmrAreaListExcel.do" id="btnExcelDownload" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> 엑셀 다운로드</a>
				</div>
	...
	<javascript>
		...
		<script src="${CTX_ROOT}/resources/decms/shop/stats/cstmr/js/cstmrAreaManage.js"></script>
	</javascript>
</body>
</html>