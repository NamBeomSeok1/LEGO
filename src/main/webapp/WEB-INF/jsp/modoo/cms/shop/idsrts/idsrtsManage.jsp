...
<c:set var="pageTitle" value="도서산간지역 관리"/>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="card shadow page-wrapper">
		...
		<div class="card-body">
			<form:form modelAttribute="searchVO" id="searchForm" name="searchForm" method="get" action="${CTX_ROOT }/decms/shop/idsrts/idsrtsList.json">
				<fieldset>
				...
				<div class="row">
						...
						<div class="form-row">
							<div class="col-auto">
								...
								<form:select path="searchCondition" cssClass="form-control custom-select custom-select-sm">
									...
									<form:option value="zip">우편번호</form:option>
								</form:select>
							</div>
							<div class="col-auto">
					...
					<div class="col-lg-4">
						<div class="text-right">
							<c:url var="writeUrl" value="/decms/embed/shop/idsrts/writeIdsrts.do"/>
							<a href="<c:out value="${writeUrl }"/>" class="btn btn-primary btn-sm btnAdd" data-target="#idsrtsModal"><i class="fas fa-plus"></i> 신규등록</a>
						</div>
					</div>
				</div>
			</form:form>
	...
	<div class="modal fade" id="idsrtsModal" tabindex="-1" role="dialog" aria-labelledby="idsrtsModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable modal-dark">
			<div class="modal-content">
				<div class="modal-header">
					<h6 class="modal-title" id="idsrtsModalLabel">수정</h6>
	...
	<javascript>
		...
		<script src="${CTX_ROOT}/resources/decms/shop/idsrts/js/idsrtsManage.js"></script>
	</javascript>
</body>
</html>