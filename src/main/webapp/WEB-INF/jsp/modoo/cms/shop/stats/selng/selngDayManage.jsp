...
<c:set var="pageTitle" value="일별매출"/>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="card shadow page-wrapper">
		...
		<div class="card-body">
			<form:form modelAttribute="searchVO" id="searchForm" name="searchForm" method="get" action="${CTX_ROOT }/decms/shop/stats/selngDayList.json">
				<fieldset class="cms-search-box container-fluid rounded pt-3 pb-3 mb-3">
					...
					<div>
						...
						<button type="button" class="btnDateSearch btn btn-secondary btn-sm" data-begin="${searchYesterday }" data-end="${searchYesterday }">어제</button>
			...
			<div class="mt-2">
				...
				<div class="text-right">
					<a href="${CTX_ROOT }/decms/shop/stats/selngDayListExcel.do" id="btnExcelDownload" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> 엑셀 다운로드</a>
				</div>
	...
	<javascript>
		...
		<script src="${CTX_ROOT}/resources/decms/shop/stats/selng/js/selngDayManage.js?2020"></script>
	</javascript>
</body>
</html>