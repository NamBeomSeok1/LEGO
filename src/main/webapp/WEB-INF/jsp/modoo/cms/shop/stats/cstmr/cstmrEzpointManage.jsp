...
<c:set var="pageTitle" value="Ez 포인트 사용분석"/>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="card shadow page-wrapper">
		...
		<div class="card-body">
			<form:form modelAttribute="searchVO" id="searchForm" name="searchForm" method="get" action="${CTX_ROOT }/decms/shop/stats/cstmrEzpointList.json">
			...
			<div class="mt-2">
				...
				<div class="text-right">
					<a href="${CTX_ROOT }/decms/shop/stats/cstmrEzpointListExcel.do" id="btnExcelDownload" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> 엑셀 다운로드</a>
				</div>
	...
	<javascript>
		...
		<script src="${CTX_ROOT}/resources/decms/shop/stats/cstmr/js/cstmrEzpointManage.js"></script>
	</javascript>
</body>
</html>