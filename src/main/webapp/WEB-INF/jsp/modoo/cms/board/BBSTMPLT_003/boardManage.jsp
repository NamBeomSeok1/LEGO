...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${CTX_ROOT}/resources/decms/common/css/decms.css"/>
	...
	<script>
        var CTX_ROOT = '${CTX_ROOT}'; <%-- Document ROOT PATH --%>
    </script>
</head>
<body>
    ...
    <script src="${CTX_ROOT}/resources/decms/common/js/script.js"></script>
	...
	<script src="${CTX_ROOT}/resources/decms/board/${boardMaster.bbsTmplatCode }/js/boardArticleManage.js?2020"></script>
