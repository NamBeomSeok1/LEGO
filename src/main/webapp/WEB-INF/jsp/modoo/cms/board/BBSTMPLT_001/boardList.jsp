...
<body>
	...
	<div class="card shadow page-wrapper">
		...
		<div class="card-body">
			...
			<div id="data-grid" class="mt-3" data-list-count="${boardMaster.listCo }" data-isadmin="${IS_ADMIN}"></div>
...
<javascript>
	...
	<script src="${CTX_ROOT}/resources/decms/board/${boardMaster.bbsTmplatCode }/js/boardArticleList.js?2020"></script>
