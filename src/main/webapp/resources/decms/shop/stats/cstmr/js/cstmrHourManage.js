(function() {
	...
	const grid = new tui.Grid({
		...
		columns: [
			{ header: '시간', name: 'deHour', width:100, align: 'center'},
	...
	//매출
	function drawHourChart(chartTitle, dataList) {
		$('#chart1').html('');
		...
		$.ajax({
			...
			success: function(result) {
				...
				if(result.success) {
					...
					drawHourChart('요일별 분석',result.data.list);
				}
			}
		});
	};
