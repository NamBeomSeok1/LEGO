...
<%
	...
	*/
	...
	String mid					= "foxeducokB";		// 가맹점 ID(가맹점 수정후 고정)					
	
	//인증
	String signKey			    = "eTYxZmNBSEY0aE5FYllSS2ViU0cyUT09";	// 가맹점에 제공된 웹 표준 사인키(가맹점 수정후 고정)
	...
	/* 기타 */
	String siteDomain = "http://store.foxedu.kr/INIpayStdSample"; //가맹점 도메인 입력
						...
						<td>
                            ...
                            <input  style="width:100%;" name="returnUrl" value="<%=siteDomain%>/INIStdPayRelay.jsp" >
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">												
												...
												<br/><input  style="width:100%;" name="offerPeriod" value="20220207-20220208" >
												<br/><br/>
