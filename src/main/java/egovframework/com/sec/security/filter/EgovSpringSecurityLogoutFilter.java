...
public class EgovSpringSecurityLogoutFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		String logoutUserId = ((LoginVO)EgovUserDetailsHelper.getAuthenticatedUser()).getUniqId();
		...
		((HttpServletRequest)request).getSession().setAttribute("logoutUserId", logoutUserId);
