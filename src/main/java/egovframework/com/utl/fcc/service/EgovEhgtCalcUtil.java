		...
		switch (srcChr) {
			...
			case EGHT_USD: // 미국
				if (cnvrChr == 'U')
					...
					sCnvrAmount = ((bSrcAmount.multiply(bSrcStdrRt).setScale(4, RoundingMode.HALF_UP)).divide(bCnvrStdrRt, 2, RoundingMode.HALF_UP)).multiply(bStdr).setScale(2, RoundingMode.HALF_UP).toString();
				else
