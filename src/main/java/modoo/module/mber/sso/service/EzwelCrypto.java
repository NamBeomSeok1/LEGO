...
// reorder for little endian	  
	...
	/**
	 * �ѱ�������ȣ����� �ҽ��� ���� �߰� �� �Լ��� �Է� ���� ���ڿ��� Ư�� Charset���� ��ȯ�Ͽ� ��ȣȭ �Ͽ� �����Ѵ�.
	 * 
	 * @param inData
	 *            String ��
	 * @param szKey
	 *            byte[] key
	 * @param charset
	 *            String String�� byte �����ͷ� ��ȯ�Ҷ� ����� charset
	 * @return byte[] ��ȣȭ �� ������
	 */
	...
	/**
	 * �ѱ�������ȣ����� �ҽ��� ���� �߰� �� �Լ��� ��ȣȭ �� ����Ʈ �����͸� �޾Ƽ� ��ȣȭ�Ͽ� ������ charset���� ���ڿ���
	 * ��ȯ�Ѵ�.
	 * 
	 * @param encryptBytes
	 *            byte[] ��ȣȭ �� ����Ʈ ������
